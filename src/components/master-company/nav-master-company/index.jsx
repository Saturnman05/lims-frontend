...
import "../../../styles/master-company/nav-master-company/index.css";
import { Avatar } from "antd";
import { CSSTransition } from "react-transition-group";

export function NavMasterCompany() {
  ...
  return (
    <nav className="nav-lab-header">
      ...
      <ul className="nav-links">
        <li>
          <CustomLink to="/layout-lab-manager/samples">Solicitudes de Muestras</CustomLink>
        </li>
        <li>
        ...
        <li>
          <CustomLink to="/layout-lab-manager/informs">Gestion de empleados</CustomLink>
        </li>
        <li>
